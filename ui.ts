...
pinkGain.gain.exponentialRampToValueAtTime(
0.034,
now+5
)
...
/* фиксируем текущее значение громкости */
...
/* отключаем ноды только после fade */
